...
template <typename data_type>
void composite_viewer_of<data_type>::copy(widget const& other)
{
...
template <typename data_type>
template <typename sub_data_type>
void composite_viewer_of<data_type>::add_sub_viewer(sub_data_type data_type::*data_member, std::string_view name)
{
...
template <typename data_type>
template <typename sub_data_type>
void composite_viewer_of<data_type>::add_sub_viewer(
...
template <typename data_type>
void composite_viewer_of<data_type>::draw_contents(data_type const& data) const
{
	_data_proxy = &data;
